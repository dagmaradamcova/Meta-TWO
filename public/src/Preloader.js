...
MetaTWO.Preloader.prototype = {
  ...
  preload: function () {
    ...
    this.loadingText = MetaTWO.game.add.text(370, 230, "Loading", {
      font: "24px Arial",
      fill: "#ffffff",
      align: "right",
    });
  ...
  create: function () {
    ...
    /* Set volume */
    let vol = 0.05; // choose value between 0 and 1

    MetaTWO.audio.clear1.volume = vol;
    MetaTWO.audio.clear4.volume = vol;
    MetaTWO.audio.crash.volume = vol;
    MetaTWO.audio.lock.volume = vol;
    MetaTWO.audio.music.volume = vol;

    MetaTWO.audio.music_fast.volume = vol;

    MetaTWO.audio.levelup.volume = vol;
    MetaTWO.audio.move.volume = vol;
    MetaTWO.audio.pause.volume = vol;
    MetaTWO.audio.rotate.volume = vol;
    MetaTWO.audio.slam.volume = vol;
  ...
  soundDecoded: function () {
    ...
    this.preloader.scale.set(
      1.0 + this.numberOfDecodedSounds / this.soundList.length,
      1.0
    );
  },
